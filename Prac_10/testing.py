...
def format_phrase(phrase):
    """
    Format a phrase, starting with a capital and ending with a full stop
    >>> format_phrase('hello')
    'Hello.'
    >>> format_phrase('It is an ex parrot.')
    'It is an ex parrot.'
    >>> format_phrase('Uuuuuuh cheese is cool.')
    'Uuuuuuh cheese is cool.'
    """
    # capitalise the first letter
    phrase_format = phrase.capitalize()
